...
description: "C++ fundamentals review"
},
{
...
description: "Odoo framework - Review of basic and complex modules"
},
{
...
for (let j = 0; j < activities.length; j++) {
  let activity = `<p><strong>${activities[j].time}:</strong> ${activities[j].description}</p><br></br>`;
